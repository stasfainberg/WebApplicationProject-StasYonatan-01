...
namespace Tachzukanit.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(TachzukanitContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,Name,Role,Email,FacebookId,Phone,Address")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("UserId,Name,Role,Email,FacebookId,Phone,Address")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
